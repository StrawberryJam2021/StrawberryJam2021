...
namespace Celeste.Mod.StrawberryJam2021.Entities {
    ...
    public class DirectionInsenativeTimedTriggerSpikes : Entity {
        ...
        protected struct SpikeInfo {
            public DirectionInsenativeTimedTriggerSpikes Parent;
        ...
        public static Entity LoadUp(Level level, LevelData levelData, Vector2 offset, EntityData entityData) =>
            new DirectionInsenativeTimedTriggerSpikes(entityData, offset, Directions.Up);
        public static Entity LoadDown(Level level, LevelData levelData, Vector2 offset, EntityData entityData) =>
            new DirectionInsenativeTimedTriggerSpikes(entityData, offset, Directions.Down);
        public static Entity LoadLeft(Level level, LevelData levelData, Vector2 offset, EntityData entityData) =>
            new DirectionInsenativeTimedTriggerSpikes(entityData, offset, Directions.Left);
        public static Entity LoadRight(Level level, LevelData levelData, Vector2 offset, EntityData entityData) =>
            new DirectionInsenativeTimedTriggerSpikes(entityData, offset, Directions.Right);
        ...
        private static IDetour hook_DirectionInsenativeTimedTriggerSpikes_GetHue;

        internal static void LoadDelayed() {
            hook_DirectionInsenativeTimedTriggerSpikes_GetHue = new ILHook(
                typeof(DirectionInsenativeTimedTriggerSpikes).GetMethod(nameof(GetHue)),
                DirectionInsenativeTimedTriggerSpikes_GetHue);
        }

        internal static void Unload() {
            hook_DirectionInsenativeTimedTriggerSpikes_GetHue.Dispose();
        }

        private static void DirectionInsenativeTimedTriggerSpikes_GetHue(ILContext il) {
            FieldInfo crystalSpinner = typeof(DirectionInsenativeTimedTriggerSpikes).GetField(nameof(DirectionInsenativeTimedTriggerSpikes.crystalSpinner), BindingFlags.NonPublic | BindingFlags.Static);
            il.Instrs.Clear();
