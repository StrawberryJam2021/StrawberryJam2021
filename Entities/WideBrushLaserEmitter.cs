...
//             var start = offset / 2;
//             return Enumerable.Range(0, count).Select(i => ConfigureSprite(StrawberryJam2021Module.SpriteBank.Create("wideBrushLaserEmitter"), start + offset * i));
//         }
//
//         protected override IEnumerable<Sprite> CreateBackSprites() {
//             const int tileSize = 8;
//             int count = (Size - tileSize) / (tileSize * 2);
//             var offset = Orientation.Vertical() ? new Vector2(tileSize * 2, 0) : new Vector2(0, tileSize * 2);
//             var start = offset;
//             return Enumerable.Range(0, count).Select(i => ConfigureSprite(StrawberryJam2021Module.SpriteBank.Create("wideBrushLaserEmitterBack"), start + offset * i));
//         }
//
//         protected override Sprite CreateBeamSprite() => StrawberryJam2021Module.SpriteBank.Create("wideBrushLaserBeam");
//     }
// }