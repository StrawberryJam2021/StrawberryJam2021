...
namespace Celeste.Mod.StrawberryJam2021.Entities {
    ...
    public class LaunchPlatform : JumpThru {
        ...
        public override void Added(Scene scene) {
            ...
            var texture = GFX.Game["objects/woodPlatform/default"];
            textures = Enumerable
        ...
        private IEnumerator Sequence() {
            ...
            while (true) {
                while (!platform.HasPlayerRider()) {
                    platform.MoveTo(start + addY * Vector2.UnitY);
                    yield return null;
                }
                ...
                while (at < 1f) {
                    ...
                    platform.MoveTo(Vector2.Lerp(start, end, Ease.CubeIn(at)) + addY * Vector2.UnitY);
                }
                ...
                while (at < 1f) {
                    ...
                    platform.MoveTo(Vector2.Lerp(end, start, at) + addY * Vector2.UnitY);
                }
