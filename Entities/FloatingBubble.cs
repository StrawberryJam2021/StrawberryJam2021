...
namespace Celeste.Mod.StrawberryJam2021.Entities {
    public class FloatingBubble : Actor {
        ...
        private bool broken;
        private static readonly MethodInfo SpringBounceAnimate = typeof(Spring).GetMethod("BounceAnimate", BindingFlags.NonPublic | BindingFlags.Instance);
        private static Hook FlagTouchSwitchCtorHook;
        private static readonly ConstructorInfo FlagTouchSwitchCtorInfo = typeof(FlagTouchSwitch).GetConstructor(new[] { typeof(EntityData), typeof(Vector2) });
        private static readonly MethodInfo OnFlagTouchSwitchCtorInfo = typeof(FloatingBubble).GetMethod("OnFlagTouchSwitchCtor", BindingFlags.Public | BindingFlags.Static);
