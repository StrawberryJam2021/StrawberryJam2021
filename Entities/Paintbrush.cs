...
namespace Celeste.Mod.StrawberryJam2021.Entities {
    ...
    public class Paintbrush : OrientableEntity {
        ...
        public Paintbrush(EntityData data, Vector2 offset, Orientations orientation)
            ...
            largeBrushSprite = configureSprite(StrawberryJam2021Module.SpriteBank.Create("paintbrushLargeBrush"));
            smallBrushSprite = configureSprite(StrawberryJam2021Module.SpriteBank.Create("paintbrushSmallBrush"));
            paintParticlesSprite = configureSprite(StrawberryJam2021Module.SpriteBank.Create("paintbrushPaintParticles"));
            paintBackSprite = configureSprite(StrawberryJam2021Module.SpriteBank.Create("paintbrushPaintBack"));
        ...
        private void renderBeam(Hitbox beamHitbox, int index) {
            ...
            float length = Math.Abs(Orientation switch {
                ...
                Orientations.Down => beamSprite.Y - beamHitbox.Bottom,
                Orientations.Left => beamSprite.X - beamHitbox.Left,
                Orientations.Right => beamSprite.X - beamHitbox.Right,
                _ => 0,
            });
