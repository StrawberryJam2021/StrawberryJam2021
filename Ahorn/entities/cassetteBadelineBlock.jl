...
@pardef CassetteBadelineBlock(
    ...
    tiletype::String = "g",
    moveForwardBeat::Integer = 0,
    moveBackBeat::Integer = 8,
    preDelay::Integer = 0,
    transitionDuration::Integer = 4,
    oneWay::Bool = false,
    teleportBack::Bool = false,
) = Entity(
    "SJ2021/CassetteBadelineBlock",
    x = x1,
    y = y1,
    ...
    height = height,
    tiletype = tiletype,
    moveForwardBeat = moveForwardBeat,
    moveBackBeat = moveBackBeat,
    preDelay = preDelay,
...
function Ahorn.renderSelectedAbs(
    ctx::Ahorn.Cairo.CairoContext,
    entity::CassetteBadelineBlock,
    room::Maple.Room,
)
