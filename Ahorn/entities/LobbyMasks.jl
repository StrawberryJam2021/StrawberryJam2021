...
const placements = Ahorn.PlacementDict(
    "Styleground Mask (Strawberry Jam 2021 **LOBBIES ONLY**)" => Ahorn.EntityPlacement(StylegroundMask, "rectangle"),
    "Color Grade Mask (Strawberry Jam 2021 **LOBBIES ONLY**)" => Ahorn.EntityPlacement(ColorGradeMask, "rectangle"),
    "Lighting Mask (Strawberry Jam 2021 **LOBBIES ONLY**)" => Ahorn.EntityPlacement(LightingMask, "rectangle"),
    "Bloom Mask (Strawberry Jam 2021 **LOBBIES ONLY**)" => Ahorn.EntityPlacement(BloomMask, "rectangle"),
    "Colorstylelightbloom Mask (Strawberry Jam 2021 **LOBBIES ONLY**)d" => Ahorn.EntityPlacement(AllInOneMask, "rectangle"),
)
