module SJ2021BeeFireball

using ..Ahorn, Maple

@mapdef Entity "SJ2021/BeeFireball" BeeFireball(x::Integer, y::Integer, nodes::Array{Tuple{Integer, Integer}, 1}=Tuple{Integer, Integer}[], amount::Integer=1, offset::Number=0.0, speed::Number=1.0)
...
const placements = Ahorn.PlacementDict(
    "Bee Fireball (Strawberry Jam 2021)" => Ahorn.EntityPlacement(
        BeeFireball,
        "point",
        Dict{String, Any}(
            "amount" => 3
...
sprite = "objects/StrawberryJam2021/beeFireball/beefireball00"
