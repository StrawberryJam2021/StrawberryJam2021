module SJ2021DirectionInsensativeTimedTriggerSpikes
...
@mapdef Entity "SJ2021/DirectionInsensativeTimedTriggerSpikesLeft" DirectionInsensativeTimedTriggerSpikesLeft(x::Integer, y::Integer, width::Integer=Maple.defaultSpikeWidth, Delay::Number=0.4, WaitForPlayer::Bool=true)
@mapdef Entity "SJ2021/DirectionInsensativeTimedTriggerSpikesUp" DirectionInsensativeTimedTriggerSpikesUp(x::Integer, y::Integer, height::Integer=Maple.defaultSpikeWidth, Delay::Number=0.4, WaitForPlayer::Bool=true)
@mapdef Entity "SJ2021/DirectionInsensativeTimedTriggerSpikesRight" DirectionInsensativeTimedTriggerSpikesRight(x::Integer, y::Integer, width::Integer=Maple.defaultSpikeWidth, Delay::Number=0.4, WaitForPlayer::Bool=true)
@mapdef Entity "SJ2021/DirectionInsensativeTimedTriggerSpikesDown" DirectionInsensativeTimedTriggerSpikesDown(x::Integer, y::Integer, height::Integer=Maple.defaultSpikeWidth, Delay::Number=0.4, WaitForPlayer::Bool=true)

const placements = Ahorn.PlacementDict()

const DirectionInsensativeTimedTriggerSpikes = Dict{String,Type}(
    "up" => DirectionInsensativeTimedTriggerSpikesUp,
    "down" => DirectionInsensativeTimedTriggerSpikesDown,
    "left" => DirectionInsensativeTimedTriggerSpikesLeft,
    "right" => DirectionInsensativeTimedTriggerSpikesRight,
)
...
const TriggerSpikesUnion = Union{
    DirectionInsensativeTimedTriggerSpikesUp,
    DirectionInsensativeTimedTriggerSpikesDown,
    DirectionInsensativeTimedTriggerSpikesLeft,
    DirectionInsensativeTimedTriggerSpikesRight,
}

for variant in spikeTypes, (dir, entity) in DirectionInsensativeTimedTriggerSpikes
    key = "Direction Insensative Timed Trigger Spikes ($(uppercasefirst(dir)), $(uppercasefirst(variant))) (Strawberry Jam 2021)"
...
const directions = Dict{String,String}(
    "SJ2021/DirectionInsensativeTimedTriggerSpikesUp" => "up",
    "SJ2021/DirectionInsensativeTimedTriggerSpikesDown" => "down",
    "SJ2021/DirectionInsensativeTimedTriggerSpikesLeft" => "left",
    "SJ2021/DirectionInsensativeTimedTriggerSpikesRight" => "right",
)
