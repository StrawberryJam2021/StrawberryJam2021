...
@mapdef Entity "SJ2021/CustomAscendManager" CustomAscendManager(x::Integer, y::Integer, backgroundColor::String="75a0ab", streakColors::String="ffffff,e69ecb", introLaunch::Bool=false)
