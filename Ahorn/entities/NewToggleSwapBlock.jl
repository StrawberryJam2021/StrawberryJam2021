module SJ2021NewToggleSwapBlock

using ..Ahorn, Maple

@mapdef Entity "SJ2021/NewToggleSwapBlock" ToggleBlock(width::Integer=16, height::Integer=16, travelSpeed::Number=5.0, oscillate::Bool=false, stopAtEnd::Bool=false,
...
const placements = Ahorn.PlacementDict(
    "New Toggle Swap Block (Strawberry Jam 2021)" => Ahorn.EntityPlacement(
        ToggleBlock,
        "rectangle",
        Dict{String, Any}(),
