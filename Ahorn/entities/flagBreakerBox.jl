module SJ2021FlagBreakerBox
using ..Ahorn, Maple

@mapdef Entity "SJ2021/FlagBreakerBox" FlagBreakerBox(x::Integer, y::Integer, width::Integer=32, height::Integer=32, flag::String="", music::String="", music_progress::Integer=-1, music_session::Bool=true, aliveState::Bool=true, flipX::Bool=false)

const placements = Ahorn.PlacementDict(
    "Flag Breaker Box (Strawberry Jam 2021)" => Ahorn.EntityPlacement(
        FlagBreakerBox,
        "rectangle"
    )
)
